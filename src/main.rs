...
use config::{
    ...
    MAX_DIGITS, RADIO_SIZE, RADIO_SPACING, RADIO_TEXT_SIZE, RADIO_TITLE_SIZE,
    ...
    fn view(&self) -> Element<Message> {
        ...
        let signature = row![
            ...
            column![
                ...
                Rule::horizontal(1.),
                row![
                    text("Roxanne Bolduc, MPA, OOAQ #4182"),
                    horizontal_space(25.)
                ],
            ]
            .width(Length::Fill)
        ...
        let method_eval = row![
            "méthode d'évaluation : conditionnement",
            radio(

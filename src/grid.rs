...
use iced::{alignment, mouse, Color, Element, Length, Point, Rectangle, Size, Theme, Vector};
    ...
    fn draw(
        ...
        let life = self.life_cache.draw(bounds.size(), |frame| {
            ...
            frame.with_save(|frame| {
                ...
                frame.scale(Vector::new(self.scaling, self.scaling));
                frame.translate(self.translation);
                frame.scale(Vector::new(Cell::SIZE as f32, Cell::SIZE as f32));
        ...
        let overlay = {
            ...
            let text = Text {
                color: Color::WHITE,
                size: 14.0,
                position: Point::new(frame.width() + 50.0, frame.height()),
